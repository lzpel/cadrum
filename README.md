...
### Minimal: create a box and export to STEP ([`examples/box.rs`](examples/box.rs))
...
### Full: build a chijin drum with colors, boolean ops, and SVG export ([`examples/chijin.rs`](examples/chijin.rs))
